...
function displayList(){
	for (var i = 0; i < myPlayList.length; i++) {
		$("#songs").append("<div class=\"col-md-12\"><div class=\"thumbnail\"><h4 class=\"text-center\">" + "  " + myPlayList[i].title + "--" + myPlayList[i].artist + "  " + "</h4><img class=\"img-responsive\" src=\"" + myPlayList[i].imageUrl + "\" /><br><a href=\"" + myPlayList[i].mp3Url + "\"><button class=\"btn btn-outline\">Play</button></a></div></div>");
	}
}
